    ...
    <div className="dailypixel-page">
      ...
      <main className="dailypixel-main">
        {tasks.map((t) => (
          <button
            key={t.id}
            className="dailypixel-card"
            onClick={() => openEdit(t.id)}
          >
            <div className="dailypixel-left">
              <div className="dailypixel-title">{t.title}</div>
              <div className="dailypixel-note">{t.note}</div>
            </div>
            <div className="dailypixel-square" aria-hidden></div>
          </button>
        ))}
      </main>
